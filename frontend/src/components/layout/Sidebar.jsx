    ...
    <div className="flex flex-col h-full bg-white border-r border-neutral-200">
      ...
      <div className="shrink-0 border-t border-neutral-200 px-3 py-3">
        ...
        <button
          ...
          className="mt-1 flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm font-medium text-neutral-600 hover:bg-red-50 hover:text-red-600 transition-colors"
        >
          <LogOut size={16} />
          Çıkış Yap
        </button>
