...
function CustomerCard({ customer, onDeleteClick, index }) {
  const navigate = useNavigate();
  return (
    <div
      className="flex items-center gap-3 p-4 border-b border-gray-100 last:border-0 active:bg-gray-50 transition-colors animate-fade-in"
    ...
    >
      ...
      <div className="flex items-center gap-1 shrink-0">
        <button
          ...
          className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors"
          aria-label="Sil"
        >
          <Trash2 size={16} />
        </button>
        <button
          onClick={() => navigate(`/customers/${customer.id}`)}
          className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors"
          aria-label="Detay"
        >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        title="Detay"
                        className="p-1.5 min-w-[36px] min-h-[36px] flex items-center justify-center text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors"
                      >
                        <Eye size={16} />
                      </button>
                      <button
                        ...
                        title="Sil"
                        className="p-1.5 min-w-[36px] min-h-[36px] flex items-center justify-center text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
